        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-6" data-aos="fade-left" data-aos-delay="200">
            <div class="image-wrapper">
              <img src="./src/assets/img/health/facilities-6.webp" class="img-fluid main-image" alt="Healthcare facility"/>
              <div class="floating-image" data-aos="zoom-in" data-aos-delay="400">
                <img src="./src/assets/img/health/staff-8.webp" class="img-fluid" alt="Medical team"/>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row justify-content-center">
            <div class="col-lg-2 col-md-3 col-sm-4 col-6" data-aos="zoom-in" data-aos-delay="100">
              <div class="certification-item">
                <img src="./src/assets/img/clients/clients-1.webp" class="img-fluid" alt="Healthcare certification"/>
              </div>
            </div>
            <div class="col-lg-2 col-md-3 col-sm-4 col-6" data-aos="zoom-in" data-aos-delay="200">
              <div class="certification-item">
                <img src="./src/assets/img/clients/clients-2.webp" class="img-fluid" alt="Medical accreditation"/>
              </div>
            </div>
            <div class="col-lg-2 col-md-3 col-sm-4 col-6" data-aos="zoom-in" data-aos-delay="300">
              <div class="certification-item">
                <img src="./src/assets/img/clients/clients-3.webp" class="img-fluid" alt="Healthcare certification"/>
              </div>
            </div>
            <div class="col-lg-2 col-md-3 col-sm-4 col-6" data-aos="zoom-in" data-aos-delay="400">
              <div class="certification-item">
                <img src="./src/assets/img/clients/clients-4.webp" class="img-fluid" alt="Medical certification"/>
              </div>
            </div>
            <div class="col-lg-2 col-md-3 col-sm-4 col-6" data-aos="zoom-in" data-aos-delay="500">
              <div class="certification-item">
                <img src="./src/assets/img/clients/clients-5.webp" class="img-fluid" alt="Healthcare accreditation"/>
              </div>
            </div>
          </div>
        </div>
