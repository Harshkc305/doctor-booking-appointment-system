        ...
        <div className="row align-items-center">
          ...
          <div className="col-lg-6" data-aos="fade-left" data-aos-delay="300">
            <div className="about-visual">
              <div className="main-image">
                <img src="./src/assets/img/health/facilities-9.webp" alt="Modern medical facility" className="img-fluid"/>
              </div>
        ...
        <div className="row g-5">
          ...
          <div className="col-lg-6" data-aos="zoom-in" data-aos-delay="100">
            <div className="specialty-card">
              ...
              <div className="specialty-visual">
                <img src="./src/assets/img/health/cardiology-1.webp" alt="Cardiovascular Medicine" className="img-fluid"/>
          ...
          <div className="col-lg-6" data-aos="zoom-in" data-aos-delay="200">
            <div className="specialty-card">
              ...
              <div className="specialty-visual">
                <img src="./src/assets/img/health/neurology-4.webp" alt="Neurological Sciences" className="img-fluid"/>
                <div className="visual-overlay">
          ...
          <div className="col-lg-8" data-aos="fade-right" data-aos-delay="200">
            <div className="featured-service-main">
              <div className="service-image-wrapper">
                <img src="./src/assets/img/health/consultation-4.webp" alt="Premier Healthcare Services" className="img-fluid"
                  loading="lazy"/>
        ...
        <div className="specialties-grid" data-aos="fade-up" data-aos-delay="300">
          <div className="row align-items-center">
            ...
            <div className="col-lg-3 col-md-6">
              <div className="specialty-card">
                <div className="specialty-image">
                  <img src="./src/assets/img/health/maternal-2.webp" alt="Maternal Care" className="img-fluid" loading="lazy"/>
                </div>
                <div className="specialty-content">
                  <h5>Maternal Care</h5>
            ...
            <div className="col-lg-3 col-md-6">
              <div className="specialty-card">
                <div className="specialty-image">
                  <img src="./src/assets/img/health/vaccination-3.webp" alt="Vaccination" className="img-fluid" loading="lazy"/>
                </div>
                <div className="specialty-content">
                  <h5>Vaccination</h5>
            ...
            <div className="col-lg-3 col-md-6">
              <div className="specialty-card">
                <div className="specialty-image">
                  <img src="./src/assets/img/health/emergency-1.webp" alt="Emergency Care" className="img-fluid" loading="lazy"/>
                </div>
                <div className="specialty-content">
            ...
            <div className="col-lg-3 col-md-6">
              <div className="specialty-card">
                <div className="specialty-image">
                  <img src="./src/assets/img/health/facilities-6.webp" alt="Advanced Tech" className="img-fluid" loading="lazy"/>
                </div>
                <div className="specialty-content">
      ...
      <div className="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div className="doctors-grid" data-aos="fade-up" data-aos-delay="300">
          <div className="doctor-profile" data-aos="zoom-in" data-aos-delay="100">
            <div className="profile-header">
              <div className="doctor-avatar">
                <img src="./src/assets/img/health/staff-2.webp" alt="Dr. Amanda Foster" className="img-fluid"/>
          ...
          <div className="doctor-profile" data-aos="zoom-in" data-aos-delay="200">
            <div className="profile-header">
              <div className="doctor-avatar">
                <img src="./src/assets/img/health/staff-6.webp" alt="Dr. Marcus Johnson" className="img-fluid"/>
          ...
          <div className="doctor-profile" data-aos="zoom-in" data-aos-delay="300">
            <div className="profile-header">
              <div className="doctor-avatar">
                <img src="./src/assets/img/health/staff-4.webp" alt="Dr. Rachel Williams" className="img-fluid"/>
                <div className="status-indicator available"></div>
              </div>
              <div className="doctor-details">
          ...
          <div className="doctor-profile" data-aos="zoom-in" data-aos-delay="400">
            <div className="profile-header">
              <div className="doctor-avatar">
                <img src="./src/assets/img/health/staff-8.webp" alt="Dr. David Chen" className="img-fluid"/>
          ...
          <div className="doctor-profile" data-aos="zoom-in" data-aos-delay="500">
            <div className="profile-header">
              <div className="doctor-avatar">
                <img src="./src/assets/img/health/staff-11.webp" alt="Dr. Victoria Torres" className="img-fluid"/>
                <div className="status-indicator available"></div>
              </div>
              <div className="doctor-details">
          ...
          <div className="doctor-profile" data-aos="zoom-in" data-aos-delay="600">
            <div className="profile-header">
              <div className="doctor-avatar">
                <img src="./src/assets/img/health/staff-14.webp" alt="Dr. Benjamin Lee" className="img-fluid"/>
                <div className="status-indicator available"></div>
              </div>
              <div className="doctor-details">
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-6">
              <div className="image-container" data-aos="fade-left" data-aos-delay="300">
                <img src="./src/assets/img/health/facilities-9.webp" alt="Medical Excellence" className="img-fluid"/>
              </div>
            </div>
