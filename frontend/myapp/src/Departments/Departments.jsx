        ...
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              ...
              <p class="mb-0">
                Compassionate care for every patient. Dedicated to your long-term health. We offer specialized treatments and expert medical advice tailored to your needs. Better living starts with us. Trust our medical expertise. Your wellness is our goal.
              </p>
            </div>
          </div>
        </div>
              ...
              <div class="tab-content department-content" id="specialty-content" data-aos="fade-up"
                  ...
                  <div class="row department-layout">
                    <div class="col-lg-4 order-lg-2">
                      <div class="department-image">
                        <img src="./src/assets/img/health/neurology-3.webp" alt="Neurology Department" class="img-fluid"/>
                      </div>
                    </div>
                ...
                <div class="tab-pane fade" id="departments-tabs-surgery" role="tabpanel" aria-labelledby="surgery-tab">
                  <div class="row department-layout">
                    <div class="col-lg-4 order-lg-2">
                      <div class="department-image">
                        <img src="./src/assets/img/health/surgery-2.webp" alt="Surgery Department" class="img-fluid"/>
                      </div>
                    </div>
                    <div class="col-lg-8 order-lg-1">
                      <div class="department-info">
                ...
                <div class="tab-pane fade" id="departments-tabs-dental" role="tabpanel" aria-labelledby="dental-tab">
                  <div class="row department-layout">
                    <div class="col-lg-4 order-lg-2">
                      <div class="department-image">
                        <img src="./src/assets/img/health/dermatology-1.webp" alt="Dental Care Department" class="img-fluid"/>
                      </div>
                    </div>
                    <div class="col-lg-8 order-lg-1">
                      <div class="department-info">
                ...
                <div class="tab-pane fade" id="departments-tabs-ophthalmology" role="tabpanel"
                  ...
                  <div class="row department-layout">
                    <div class="col-lg-4 order-lg-2">
                      <div class="department-image">
                        <img src="./src/assets/img/health/pediatrics-4.webp" alt="Ophthalmology Department" class="img-fluid"/>
                      </div>
                    </div>
                    <div class="col-lg-8 order-lg-1">
                      <div class="department-info">
                ...
                <div class="tab-pane fade" id="departments-tabs-cardiology" role="tabpanel"
                  ...
                  <div class="row department-layout">
                    <div class="col-lg-4 order-lg-2">
                      <div class="department-image">
                        <img src="./src/assets/img/health/cardiology-3.webp" alt="Cardiology Department" class="img-fluid"/>
                      </div>
                    </div>
                    <div class="col-lg-8 order-lg-1">
                      <div class="department-info">
        ...
        <div class="row g-5">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="department-card">
              ...
              <div class="department-image">
                <img src="./src/assets/img/health/neurology-2.webp" alt="Neurology Department" class="img-fluid"/>
              </div>
              <div class="department-content">
                <h3>Neurology</h3>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="department-card">
              ...
              <div class="department-image">
                <img src="./src/assets/img/health/orthopedics-4.webp" alt="Orthopedics Department" class="img-fluid"/>
              </div>
              <div class="department-content">
                <h3>Orthopedics</h3>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="department-card">
              ...
              <div class="department-image">
                <img src="./src/assets/img/health/pediatrics-3.webp" alt="Pediatrics Department" class="img-fluid"/>
              </div>
              <div class="department-content">
                <h3>Pediatrics</h3>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="department-card">
              ...
              <div class="department-image">
                <img src="./src/assets/img/health/dermatology-4.webp" alt="Dermatology Department" class="img-fluid"/>
              </div>
              <div class="department-content">
                <h3>Dermatology</h3>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="department-card">
              ...
              <div class="department-image">
                <img src="./src/assets/img/health/oncology-2.webp" alt="Oncology Department" class="img-fluid"/>
              </div>
              <div class="department-content">
                <h3>Oncology</h3>
